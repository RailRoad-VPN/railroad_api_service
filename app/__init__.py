...
# VPNC API
vpnserver_service = VPNServerService(api_url=app.config['VPNC_SERVICE_URL'],
...
vpnc_api_view_func = VPNServersAPI.as_view('vpnc_api', vpnserver_service, vpntype_service,
                                           vpnserverconfiguration_service, vpnserverstatus_service, geoposition_service,
                                           geocity_service, geocountry_service, geostate_service, app.config)
